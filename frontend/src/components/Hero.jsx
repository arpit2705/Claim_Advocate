    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full z-10">
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          ...
          >
            {/* The Globe */}
            <div className="absolute inset-0 z-0 flex items-center justify-center transition-transform duration-1000 ease-out"
                 style={{ transform: `scale(${isHovered ? 1.15 : 1.1})` }}>
               <div className="w-full h-full lg:max-w-[110%] flex items-center justify-center">
                 <InsuranceGlobe />
               </div>
            </div>
          </div>
